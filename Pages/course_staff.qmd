...
|------------------|------------|------------------|---------------------------|
|                                          | **Name**  | **Sections**                                                | **OH**                                                    |
| ![](../Images/Profiles/placeholder2.png) | TBD   | 2 - 2:50 pm (PHELPS 1518) <br / > 3 - 3:50 pm (PHELPS 1518) | TBD |                                                 |
| ![](../Images/Profiles/placeholder2.png) | TBD | 4 - 4:50 pm (PHELPS 1517) <br / > 5 - 5:50 pm (PHELPS 1513) | TBD |
